...
if (isset($_POST["save"])) {
    ...
    $Addjob_Financial = $controller->Addjob($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive,  $Finish, $Sub, $Department, $Section);
...
if (isset($_POST['sub'])) {
    ...
    // foreach ($txt as $text) {
        ...
        $Addsub_Financial = $controller->Addsub($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive, $Finish, $Department, $Section);
...
<body>
    <div class="head">
      <div>
        <a href="../index.php"><h3>Financial Requirement</h3></a>
      </div>
      <div id="login">
        <div>
    ...
    <h1 class="text-center mt-4">Job Financial</h1>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Job Financial Requirement </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class=" " action="Financial.php" method="post">
                        <div class="d-flex justify-content-start w-50 ">
                            ...
                            <div class="col-md-4 position-relative m-2">
                                ...
                                <input type="text" readonly class="form-control text-center" value="Financial" name="Section">
                            </div>
                        </div>
                        <div class=" mt-3">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-secondary text-white">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">SubJob Financial Requirement </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class=" " action="Financial.php" method="post">
