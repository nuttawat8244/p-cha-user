...
if (@isset($_POST['Receive'])) {
    ...
    if (!empty($_POST["ids"])) {
        ...
        $update = $controller->receive_jobsub($all,$count,$Subject);
     
        require_once "mail_reply_sub.php";
            ...
            <tbody>
                ...
                while (@$row = @$result->fetch(PDO::FETCH_ASSOC)) { 
                    ...
                    <tr>
                        ...
                        <td class="detail" width=20%> <?php echo @$row['Problem']; ?></td>
                        <td class="detail" width=27%> <?php echo @$row['Requirement']; ?> </td>
                        <td><?php echo @$row['Request_by']; ?></td>
                        <td><?php echo @$row['Receive']; ?> </td>
                        <td class="finish"> <?php echo @$row['Finish']; ?> </td>
                        <!-- <td></td> -->
                        <!-- <td>test</td> -->
                    </tr>
                <?php } ?>
